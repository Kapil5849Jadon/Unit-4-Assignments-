require("dotenv").config();// this is to get data from .env file, because it is has no direct access
const jwt = require("jsonwebtoken");// this is to create token
...
const register = async (req, res) => {
  try {
    ...
    // hashing => hashes it => CANNOT get original string back
    //encryption => string=> encrypted_string=> decrypt => decrypt => original 
